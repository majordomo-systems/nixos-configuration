...
let
  ...
  tilixSettingsScript = ''
    ...
    dconf write /com/gexperts/Tilix/profiles/2b7c4080-0ddd-46c5-8f23-563fd3ba789d/background-transparency-percent 70
...
in
{
  ...
  home.activation.applyTilixSettings = lib.mkAfter ''
    ${pkgs.writeScript "apply-tilix-settings" ''
      ...
      ${pkgs.dconf}/bin/dconf write /com/gexperts/Tilix/profiles/2b7c4080-0ddd-46c5-8f23-563fd3ba789d/background-transparency-percent 30
